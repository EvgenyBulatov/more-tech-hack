...
newLinesT = spark.read.orc(your_table).where(col("eff_to_month") == "5999-12-31").count()
closedLinesT = spark.read.orc(your_table).where(col("eff_to_month") != "5999-12-31").count()
